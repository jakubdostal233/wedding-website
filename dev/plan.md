...
1. 🧪 **Owner-side real-device QA.** Run [../docs/qa-checklist.md](../docs/qa-checklist.md) on real phones/tablets (mobile data + Wi-Fi): the three maps, the `.ics` on iOS/Android, the `mailto:`, and the bank QR in **two** banking apps. New since 2026-07-07: also tap the two Gröbovka parking links and check the inline seating plans on a real phone (pinch-zoom readability + the "otevřít samostatně" links). The desktop + automated side is done (2026-07-03 QA pass + 2026-07-07 render checks); this is the physical-device part only you can do.
